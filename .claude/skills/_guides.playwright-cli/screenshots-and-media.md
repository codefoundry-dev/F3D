...
> **When to use**: Capturing visual evidence of page state — screenshots for verification, video
> recordings for demos or debugging, PDF exports for documentation, viewport resizing for responsive
> testing. **Prerequisites**: [core-commands.md](core-commands.md) for basic CLI usage
...
- **Always set viewport before screenshotting** — `resize` before `screenshot` for consistent
  dimensions

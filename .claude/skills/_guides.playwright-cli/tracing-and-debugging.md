...
> **When to use**: Debugging failing actions, analyzing performance bottlenecks, capturing execution
> evidence, understanding why an interaction didn't work, or inspecting network and console activity
> during automation. **Prerequisites**: [core-commands.md](core-commands.md) for basic CLI usage
...
Traces capture **everything** — DOM snapshots, screenshots, network activity, console logs, and
timing — for every action during a session.

...
export function MaterialSearchPanel({
  ...
  return (
    <div className="relative" ref={panelRef}>
      {/* Search input */}
      <div className={cn('relative group', compact && 'focus-within:bg-muted/50')}>
        <SearchIconSvg
          className={cn(
      ...
      {open && (
        <div
          className={cn(
            'absolute z-40 left-0 mt-1 bg-background border border-border rounded-xl shadow-lg flex flex-col',
            compact ? 'min-w-[600px]' : 'right-0',
            ...
            <>
              ...
              <div className="p-4">
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-medium text-foreground">{countryLabel}</label>
                    <CustomDropdown

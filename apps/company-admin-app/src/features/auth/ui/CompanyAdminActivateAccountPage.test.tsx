...
// We need to re-mock react-router-dom to allow changing searchParams per test
...
import CompanyAdminActivateAccountPage from './CompanyAdminActivateAccountPage';

describe('CompanyAdminActivateAccountPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders password form when token is valid', () => {
    render(<CompanyAdminActivateAccountPage />);

...
vi.mock('@/features/auth/ui/FinancialOfficerVerifyOtpPage', () => ({
  default: () => <div>VerifyOtp</div>,
}));
vi.mock('@/features/auth/ui/FinancialOfficerActivateAccountPage', () => ({
  default: () => <div>Activate</div>,
}));
vi.mock('@/features/auth/ui/ForgotPasswordPage', () => ({
  default: () => <div>ForgotPassword</div>,
}));
vi.mock('@/features/auth/ui/FinancialOfficerResetPasswordPage', () => ({
  default: () => <div>ResetPassword</div>,
}));
vi.mock('@/features/dashboard/pages/DashboardPage', () => ({
  default: () => <div>Dashboard</div>,
}));
vi.mock('@/features/invoices/ui/InvoiceListPage', () => ({
  default: () => <div>InvoiceList</div>,
}));
vi.mock('@/features/invoices/ui/InvoiceDetailPage', () => ({

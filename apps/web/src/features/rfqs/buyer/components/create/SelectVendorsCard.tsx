...
/**
 * "Select Vendors" block (Figma 5.05): searchable vendor table
 * (name / location / category / add) beside the selected-vendors panel with
 * "Remove all" and the at-least-one hint. Rendered inside a WizardAccordion on
 * the consolidated first step, so it carries no card chrome of its own.
 */

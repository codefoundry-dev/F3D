...
describe('UserProfilePage', () => {
  ...
  it('renders change password modal with error state', () => {
    mockChangePasswordMutation.value = {
      ...mockChangePasswordMutation.value,
      isError: true,
      error: new Error('Invalid password') as unknown as null,
    };
    render(<UserProfilePage />);
    fireEvent.click(screen.getByText('changePassword'));
    expect(screen.getByTestId('change-password-modal')).toBeInTheDocument();
  ...
  it('renders change password modal with null error fallback', () => {
    mockChangePasswordMutation.value = {
      ...mockChangePasswordMutation.value,
      isError: true,
      error: null,

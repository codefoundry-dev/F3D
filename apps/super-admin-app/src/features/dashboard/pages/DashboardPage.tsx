...
import { PlatformStateTable } from '../ui/PlatformStateTable';
import { RecentChangesTimeline } from '../ui/RecentChangesTimeline';
...
export default function DashboardPage() {
  ...
  return (
    <div className="p-4 space-y-4 overflow-auto">
      ...
      {/* Platform Overview — real data cards */}
      {dashboard && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard
      ...
      {/* Bottom Section: Recent Changes + Google Analytics */}
